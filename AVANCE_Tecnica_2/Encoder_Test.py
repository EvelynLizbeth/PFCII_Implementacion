...
data_path = '/content/drive/MyDrive/PneumoniaProject/Medical_Data_4'

keras.losses.categorical_smooth_loss = categorical_smooth_loss
reconstructed_model = keras.models.load_model("/content/drive/MyDrive/PneumoniaProject/model_fixed.keras",custom_objects={'patch_extract': patch_extract,'patch_embedding':patch_embedding,'Mlp':Mlp,
